    ...
    <main>
      ...
      <div id="main-content">
        ...
        <section className="signal-band" aria-label="Available time windows">
          <div className="signal-intro"><span className="signal-index">01</span><p>Spare moments, or the small windows already in your day.</p></div>
        ...
        <section className="section intro-section" id="how-it-works">
          <div className="section-heading split-heading">
            <div><p className="section-index">02 / The loop</p><h2>Neighbourly help, carefully coordinated.</h2></div>
        ...
        <section className="time-section section">
          <div className="time-card"><div className="time-card-copy"><p className="section-index light-index">05 / For volunteers</p><h2>Your spare time is enough.</h2><p>No fixed shifts. No long-term commitment. Share a small window, choose call or nearby help, and only accept tasks that feel right for you.</p><a className="text-link light-link" href="#volunteer">Join the pilot <LineIcon name="arrow" /></a></div><div className="time-selector" aria-label="Choose an example availability window"><span className="selector-label">I have time for</span><div className="duration-buttons">{durations.map((minutes) => <button key={minutes} type="button" className={duration === minutes ? "selected" : ""} onClick={() => setDuration(minutes)} aria-pressed={duration === minutes}><strong>{minutes}</strong><span>minutes</span></button>)}</div><div className="selector-result"><span className="pulse-dot" aria-hidden="true" /><p><strong>{duration} minutes available</strong><br />We would only show requests that fit.</p></div></div></div>
        </section>

        <section className="section safety-section" id="safety">
          <div className="section-heading split-heading"><div><p className="section-index">06 / Safety first</p><h2>Small, clear boundaries help everyone feel comfortable.</h2></div><p>Help Nearby is a pilot, not an emergency service. Trust is built through modest promises and visible human decisions.</p></div>
